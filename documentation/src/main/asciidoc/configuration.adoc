...
Character, Color, Dimensions, Duration, Enum, File, InetAddress, Instant, Locale, Period, Point, URI,
URL, and UUID.
Custom types can be supported, and existing types can be overriden, by providing an implementation of
the `ConfigResolver.Converter` interface.
